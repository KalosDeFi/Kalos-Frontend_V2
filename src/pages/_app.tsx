  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="KalosDeFi is Cheap and fast, the leading DEX on BNB Smart Chain (BSC) with the best farms in DeFi and a lottery for XALO."
        />
        <meta name="theme-color" content="#1FC7D4" />
        <meta name="twitter:image" content="https://kalosdefi.finance/images/hero.png" />
        <meta
          name="twitter:description"
          content="KalosDeFi AMM on BSC! Earn XALO through yield farming, then stake it in Kalos Pools to earn more tokens! Incubator Farm Offerings (new token launch model), NFTs, and more, on a platform you can trust."
        />
